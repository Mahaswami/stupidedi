  ...
  module Guides
    module FiftyTen
      module X223A2
		...
		# This is copy of X222-HC837P.rb and modified for X223A2-HC837I.rb
        ...
        loop2300 =
          d::LoopDef.build("2300 CLAIM INFORMATION",
              ...
              b::Segment(1300, s::CLM, "Claim Information",
                ...
                b::Element(e::Required,    "HEALTH CARE SERVICE LOCATION INFORMATION",
                  ...
                  b::Element(e::Required,    "Facility Code Qualifier", b::Values("A", "B")),
                  b::Element(e::Required,    "Claim Frequency Code")),
                b::Element(e::Situational,    "Provider or Supplier Signature Indicator", b::Values("N", "Y")),
	      ...
	      b::Segment(1350, s::DTP, "Statement Dates",
                ...
                b::Element(e::Required,    "Date - Statement Dates")),
              ...
              b::Segment(1350, s::DTP, "Admission Date",
                ...
                b::Element(e::Required,    "Date Time Period Format Qualifier", b::Values("DT", "D8")),
	      ...
	      b::Segment(1350, s::CL1, "Institutional Claim Code",
                r::Situational, d::RepeatCount.bounded(1),
		...
		b::Element(e::NotUsed, "Nursing Home Code")),
              ...
              b::Segment(2200, s::CRC, "EPSDT Referral",
                ...
                b::Element(e::NotUsed,     "Condition Indicator"),
                b::Element(e::NotUsed,     "Condition Indicator")),
	      b::Segment(2300, s::HI, "Value Information",
                r::Required, d::RepeatCount.bounded(1),
                b::Element(e::Required,    "HEALTH CARE CODE INFORMATION",
                  b::Element(e::Required,    "Qualifier", b::Values("BE")),
		...
		b::Element(e::Situational,    "HEALTH CARE CODE INFORMATION",
	      ...
	      b::Segment(2310, s::HI, "Health Care Diagnosis Code",
                ...
                b::Element(e::Required, "HEALTH CARE CODE INFORMATION",
                  ...
                  b::Element(e::NotUsed,     "Yes/No Condition or Response Code")),
                b::Element(e::Situational, "HEALTH CARE CODE INFORMATION",
                  b::Element(e::NotUsed,    "Code List Qualifier", b::Values("ABK", "BK")),
                  b::Element(e::NotUsed,    "Diagnosis Code"),
                  b::Element(e::NotUsed,     "Date Time Period Format Qualifier"),
                  b::Element(e::NotUsed,     "Date Time Period"),
                  b::Element(e::NotUsed,     "Monetary Amount"),
                  b::Element(e::NotUsed,     "Quantity"),
              ...
              b::Segment(2310, s::HI, "Health Care Diagnosis Code",
                r::Required, d::RepeatCount.bounded(1),
                b::Element(e::Situational, "HEALTH CARE CODE INFORMATION",
                  b::Element(e::Required,    "Code List Qualifier", b::Values("BF", "BF")),
                  b::Element(e::Required,    "Diagnosis Code"),
                  b::Element(e::NotUsed,     "Date Time Period Format Qualifier"),
                  b::Element(e::NotUsed,     "Date Time Period"),
                  b::Element(e::NotUsed,     "Monetary Amount"),
	      ...
	      d::LoopDef.build("2310A ATTENDING PROVIDER NAME",
                ...
                b::Segment(2500, s::NM1, "Attending Provider Name",
                  ...
                  b::Element(e::Situational, "Attending Provider Identifier"),
              ...
              d::LoopDef.build("2400 SERVICE LINE NUMBER",
                ...
                b::Segment(3700, s::SV1, "Professional Service",
                  ...
                  b::Element(e::NotUsed,     "Provider Agreement Code")),
 		b::Segment(3700, s::SV2, "Institutional Service Line",
                  r::Required, d::RepeatCount.bounded(1),
                  b::Element(e::Required,    "Revenue Code"),
                  b::Element(e::Required,    "COMPOSITE",
                  ...
                  b::Element(e::Required,    "Service Unit/Days"),
                  b::Element(e::NotUsed,     "Unit Rate"),
                  b::Element(e::Situational,     "Monetary Amount"),
                  b::Element(e::NotUsed,    "Y/N"),
                  b::Element(e::NotUsed,     "NHRSC"),
                  b::Element(e::NotUsed,     "Level of Care Code")),
        ...
        HC837I = b.build(t::HC837,
          d::TableDef.header("Table 1 - Header",
            b::Segment(50, s::ST, "Transaction Set Header",
              ...
              b::Element(e::Required,    "Implementation Guide Version Name", b::Values("005010X223A2"))),
